...
namespace CSICDemoDec
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.UseCdn = true;
            var cssTransformer = new BundleTransformer.Core.Transformers.StyleTransformer();
            var jsTransformer = new BundleTransformer.Core.Transformers.ScriptTransformer();
